...
import Item from "components/templates/aml/Main/Item";
...
const Main = ({searchValid, searchKey,searchResult }: Props) => {
  ...
  const convertDataToCSV = useCallback((data:searchResult['data']) => {
    return data.map((item:{    WE_CD:number;
            ...
            <table className="w-full h-full">
              ...
              <thead className="border-gray-200 border-b-[1px]">
                <tr className="text-[14px] text-gray-600 h-11">
                  ...
                  <th className="px-3 text-left">Countries</th>
                  <th className="px-1 text-left">Datasets</th>
